...
//
// These represent FIPS approved algorithms that should be supported by the RNG protocol and are generally considered secure.
// This list enforces a minimum set of secure algorithms that must be supported by the RNG protocol.
//
